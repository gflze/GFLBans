...
async def _get_discord_user_info(app, discord_id: str, t=0):
    ...
    async with app.state.aio_session.get(f'https://discord.com/api/users/{discord_id}',
                                         headers={'Authorization': f'Bot {DISCORD_BOT_TOKEN}',
                                                  'User-Agent': 'gflbans (bans.gflclan.com, 1.0)'}) as resp:
...
async def get_discord_user_info(app, discord_id: str):
    ...
    return {'avatar_url': f'https://cdn.discordapp.com/avatars/{info["id"]}/{info["avatar"]}.png',
