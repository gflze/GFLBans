...
GetVPNData = TaskBase(handler=ev_get_vpn_data, backoffs=[30, 60, 180, 360, 720, 3600, 3600 * 24, 3600 * 24 * 7])
GetUserData = TaskBase(handler=ev_get_user_data, backoffs=[30, 60, 180, 360, 720, 3600, 3600 * 24, 3600 * 24 * 7])
