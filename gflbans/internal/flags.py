...
# PERMISSION_EDIT_OWN_INFRACTIONS = 1 << 4 # Deprecated, all admins with PERMISSION_CREATE_INFRACTION can edit their own punishments.
...
ALL_PERMISSIONS = PERMISSION_LOGIN | PERMISSION_COMMENT | PERMISSION_VIEW_IP_ADDR | PERMISSION_CREATE_INFRACTION \
                  ...
                  | PERMISSION_MANAGE_API_KEYS | PERMISSION_MANAGE_ADMINS | PERMISSION_BLOCK_CHAT \
...
name2perms = {
    ...
    'Manage Admins': PERMISSION_MANAGE_ADMINS,
