...
# If the server isn't acting as system, they are limited by the user's permissions too
...
ALL_PERMISSIONS = PERMISSION_LOGIN | PERMISSION_COMMENT | PERMISSION_VIEW_IP_ADDR | PERMISSION_CREATE_INFRACTION \
                  | PERMISSION_EDIT_OWN_INFRACTIONS | PERMISSION_EDIT_ALL_INFRACTIONS | PERMISSION_ATTACH_FILE \
                  | PERMISSION_WEB_MODERATOR | PERMISSION_MANAGE_SERVERS | PERMISSION_MANAGE_VPNS \
                  | PERMISSION_PRUNE_INFRACTIONS | PERMISSION_VIEW_AUDIT_LOG | PERMISSION_MANAGE_GROUPS \
                  | PERMISSION_MANAGE_API_KEYS | PERMISSION_ACP_BLOCK_EDITOR | PERMISSION_BLOCK_CHAT \
                  | PERMISSION_BLOCK_VOICE | PERMISSION_BAN | PERMISSION_ADMIN_CHAT_BLOCK \
...
name2perms = {
    ...
    'Edit Own Infractions': PERMISSION_EDIT_OWN_INFRACTIONS,
    ...
    'ACP Manage Servers': PERMISSION_MANAGE_SERVERS,
    'ACP Manage VPNs': PERMISSION_MANAGE_VPNS,
    'ACP Database': PERMISSION_PRUNE_INFRACTIONS,
    'ACP Audit Log': PERMISSION_VIEW_AUDIT_LOG,
    'ACP Groups': PERMISSION_MANAGE_GROUPS,
    'ACP API Keys': PERMISSION_MANAGE_API_KEYS,
    'Restrict Voice': PERMISSION_BLOCK_VOICE,
    'Restrict Text Chat': PERMISSION_BLOCK_CHAT,
    'Ban': PERMISSION_BAN,
